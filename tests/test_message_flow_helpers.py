...
def test_get_last_message_text_returns_last_text():
    from core.helpers.message_flow_helpers import get_last_message_text
...
def test_is_btc_price_query_detects_query():
    from core.helpers.message_flow_helpers import is_btc_price_query
...
def test_extract_final_ai_text_returns_last_ai_message():
    from core.helpers.message_flow_helpers import extract_final_ai_text
