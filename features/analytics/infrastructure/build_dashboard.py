#!/usr/bin/env python3
"""
Build web dashboard: lee audit JSONL → genera features/analytics/dist/index.html

Local:
    python features/analytics/infrastructure/build_dashboard.py [data/logs/agentdog_audit.jsonl]
    python features/analytics/infrastructure/build_dashboard.py --serve      # genera + abre browser
    python features/analytics/infrastructure/build_dashboard.py --watch       # reconstruye en vivo + server en :8765

Netlify:
    Build command : python features/analytics/infrastructure/build_dashboard.py
    Publish dir   : features/analytics/dist
...
def _resolve_path() -> str:
    ...
    return env if env else "./data/logs/agentdog_audit.jsonl"
...
def build(src_path: str, out_path: str = "features/analytics/dist/index.html", *, live: bool = False) -> str:
    """Genera features/analytics/dist/index.html. live=True inyecta auto-refresh cada 5s."""
...
def _watch(src_path: str, out_path: str, poll: float = 3.0):
    ...
    # Servidor HTTP en un thread aparte (sirve features/analytics/dist/)
...
def main():
    src   = _resolve_path()
    out   = "features/analytics/dist/index.html"
