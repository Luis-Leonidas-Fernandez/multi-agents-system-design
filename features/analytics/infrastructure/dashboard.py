...
Uso:
    python features/analytics/infrastructure/dashboard.py [ruta_al_audit.jsonl]
    python features/analytics/infrastructure/dashboard.py          # lee AGENTDOG_AUDIT_LOG o ./data/logs/agentdog_audit.jsonl
    python features/analytics/infrastructure/dashboard.py --no-show  # guarda PNG sin abrir ventana
"""
import json
import os
import sys
