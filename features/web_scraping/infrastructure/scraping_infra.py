...
def _ensure_data_trading_dir() -> Path:
    """Crea la carpeta data/web_scraping/data_trading si no existe."""
...
async def _scrape_dynamic_async(
    ...
    Guarda un bundle JSON en data/web_scraping/data_trading/ con todas las respuestas capturadas.
    """
