...
from features.web_scraping.infrastructure.web_cache import _get_search_cache, _set_search_cache
from features.web_scraping.infrastructure.web_circuit_breaker import _circuit_open, _circuit_trip, _is_non_retryable_provider_error

from features.web_scraping.infrastructure.search_core import _format_search_results, _web_search_debug
...
def _execute_web_search_plan(
    ...
    try:
        from features.web_scraping.infrastructure.search_tools import _query_web_search_provider
