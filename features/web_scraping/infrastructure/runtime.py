...
from features.web_scraping.infrastructure.web_fetch_registry import (
...
def _extract_hits_from_search_text(raw_text: str) -> tuple[WebSearchHit, ...]:
    from features.web_scraping.application.flow import _extract_generic_search_candidates
