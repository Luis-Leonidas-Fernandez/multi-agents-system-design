...
**Archivo: `application/services/agents_factory.py` (primera parte)**
...
```python
"""
application/services/agents_factory.py - Definición de herramientas y agentes especializados
"""
...
**Archivo: `application/services/agents_factory.py` (segunda parte)**
