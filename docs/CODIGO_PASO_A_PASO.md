...
## 📁 Paso 2: Crear `application/services/agents_factory.py` - Parte 1 (Herramientas)

Crea un archivo llamado `application/services/agents_factory.py` y empieza con las herramientas:
...
from application.helpers.config_flow_helpers import get_llm  # Lo usaremos más adelante
...
## 📁 Paso 3: Crear `application/services/agents_factory.py` - Parte 2 (Agentes)

Continúa en el mismo archivo `application/services/agents_factory.py`:
...
from application.use_cases.supervisor_flow import math_node, AgentState
from langchain_core.messages import HumanMessage
...
from application.use_cases.supervisor_flow import supervisor_node, AgentState
from langchain_core.messages import HumanMessage
...
from application.use_cases.supervisor_flow import create_supervisor_graph
from langchain_core.messages import HumanMessage
