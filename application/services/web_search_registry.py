...
def _load_policy() -> dict[str, Any]:
    policy_path = Path(__file__).resolve().parents[1] / "policies" / "web_search_provider_policy.json"
...
def _web_search_provider_plugin_dir() -> Path:
    ...
    return Path(__file__).resolve().parents[1] / "policies" / "web_search_provider_plugins"
